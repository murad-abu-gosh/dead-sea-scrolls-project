...
if __name__ == "__main__":
    ...
    backbones = ['resnet34', 'resnet101', 'timm-regenty_320']
                ...
                for batch_size_train in batch_sizes:
                    for optimizer in range(num_of_optimizers):
                        for loss_criteria in loss_criterias:
                            ...
                            model = smp.MAnet(encoder_name = backbone, encoder_depth = encoder_depth, decoder_channels = decoder_channel,
    ...
    model = smp.MAnet(encoder_name = best_backbone, encoder_depth = best_encoder_depth, decoder_channels = best_decoder_channel,
                            in_channels = 3, classes = 1, activation = "sigmoid", decoder_use_batchnorm = True)
